...
public class DBWriter {
     ...
     * @throws Exception
     */
    private void createMemberElement(XMLEventWriter eventWriter, String name, long p_number, int m_id
    ...
    private void createNode(XMLEventWriter eventWriter, String name,
        ...
        eventWriter.add(sElement);
        // create Content
        Characters characters = eventFactory.createCharacters(Long.toString(value));
        eventWriter.add(characters);
